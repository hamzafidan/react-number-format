...
var propTypes = {
  ...
  textPrefix: _propTypes["default"].string,
  textSuffix: _propTypes["default"].string,
...
var NumberFormat = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(NumberFormat, [{
    ...
    value: function correctCaretPosition(value, caretPos, direction) {
      ...
      caretPos = (0, _utils.clamp)(caretPos, 0, value.length); //in case of format as number limit between textPrefix and textSuffix

      if (!format) {
        var hasNegation = value[0] === '-';
        return (0, _utils.clamp)(caretPos, textPrefix.length + (hasNegation ? 1 : 0), value.length - textSuffix.length);
